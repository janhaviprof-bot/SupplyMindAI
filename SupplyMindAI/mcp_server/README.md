...
**Example (Cornell `connect.systems-apps.com`):** Shiny variable `SUPPLYMIND_MCP_URL` = `https://connect.systems-apps.com/content/3eb48dc8-0322-4edd-bfd9-9edf10003a4e/mcp`. Swagger UI: `https://connect.systems-apps.com/content/3eb48dc8-0322-4edd-bfd9-9edf10003a4e/docs`. The Connect admin page for that API is `https://connect.systems-apps.com/connect/#/apps/3eb48dc8-0322-4edd-bfd9-9edf10003a4e/content-view` — that UI URL is not the MCP base; the app must use the `/content/.../mcp` URL.
